...
public:
    ...
    unsigned int N(){return _N;} /*public value of N*/
    
    unsigned int M(){return _M;} /*public value of M*/
    
    double alpha(){return _alpha;} /*public value of alpha*/

    unsigned int K(){return _K;} /*public value of K*/
    
    unsigned int time_conv(){return _time_conv_print;} /*public value of time_convergece*/
    
    unsigned int seed(){return _seed;}/*public value of seed*/
    
    unsigned int unit_prop_print(){return _unit_prop;}/*public value of unit propagations moves*/
    ...
    void unit_propagation(unsigned int  & c, unsigned long &i); /*fix the variable into clause c to true and clean the graph*/
    ...
    void fix_all_var(); /*fix all variables*/
    
    double check_instance();/*check the number of calsuses satisfied*/
    
    void number_conv_surv();
    ...
    void save_surveys(){/*save values for printing*/
        for(unsigned long i=0; i<ptrV.size(); ++i){
            ...
            _v_comp_var.push_back((static_cast<double>(ptrV[i]->_degree_i)-1.)*log(ptrV[i]->complexity_variable));
        }
...
//    int CORES = static_cast<int>(thread::hardware_concurrency());
    ...
    vector<double> _v_sT, _v_sF, _v_sI, _v_comp_var; //vector for printing on file
